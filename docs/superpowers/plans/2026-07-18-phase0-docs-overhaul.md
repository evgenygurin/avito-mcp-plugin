...
целевой дизайн Duff89-паритета (спека
[2026-07-18-duff89-parity-design.md](../specs/2026-07-18-duff89-parity-design.md)),
...
«удалено в пользу Duff89-паритета, см. spec». Статусы тулз — 🔜 «план».
...
Вписать по спеке:
- «## Что это» → плагин с фичепаритетом Duff89; **7 тулз** (перечислить из spec §4),
...
git commit -F <msg-file>
```
Сообщение: `docs: rewrite CLAUDE.md for Duff89-parity target`
...
- в схеме и «Состав репозитория» заменить тулз-строку на движок Duff89 + 7 тулз;
...
- заменить таблицу «Тулзы» на 7 тулз из spec §4 (все 🔜 план), с колонкой «Duff89-источник»;
...
что закон» → оставить техническое «как пройти антибот». Отразить найденный дефект
Duff89 (одна ротация) и фикс.
