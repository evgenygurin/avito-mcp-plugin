...
> **СТАТУС:** реализована только диагностическая тулза `ping`. Ниже — целевая
...
| Тулза | Назначение | Скил |
|---|---|---|
| `search_listings` | Поиск объявлений по запросу/региону/фильтрам | `scraping-avito` |
| `get_listing` | Детали объявления | `scraping-avito` |
| `official_api_call` | Официальный API (свои объявления) | `avito-official-api` |
| `check_proxy_health` | Диагностика прокси-пула | `scraping-avito` |
